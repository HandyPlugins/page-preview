...
/**
 * Abstract Page_Preview_WP_Background_Process class.
 *
 * @abstract
 * @extends Page_Preview_WP_Async_Request
 */
abstract class Page_Preview_WP_Background_Process extends Page_Preview_WP_Async_Request {
	 ...
	 *
	 * @param bool|array $allowed_batch_data_classes Optional. Array of class Page_Preview_names that can be unserialized. Default true (any class).
	 */
	 ...
	 * @param bool|array $allowed_classes Array of class Page_Preview_names that can be unserialized.
	 *
	 * @return mixed
	 */
